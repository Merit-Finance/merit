...
//                       type="button"
//                       onClick={() =>
//                         handleSelectSavedWallet(w.wallet, w.network as Network)
//                       }
...
//                   className="shrink-0 border border-[#E8E8E8] rounded-lg px-3 py-2.5 text-sm text-gray-700 bg-white focus:outline-none focus:ring-1 focus:ring-primary disabled:bg-gray-50 disabled:text-gray-400"
//                 >
